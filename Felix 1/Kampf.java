...
public class Kampf
{
    ...
    private static  int wahrscheinlichkeitZuFliehen=2; //jeh größer die Zahl, desto unwahrscheinlicher ist die Flucht
    ...
    public static void fliehen()
    {
        ...
        if(kannFliehen==true){
            if(yPos-1>=0){
                if(Spiel.neueWelt.welt[xPos][yPos-1].getZugaenglichkeit()==true){
                    ...
                    if(xPos+1<=49){
                        if(Spiel.neueWelt.welt[xPos+1][yPos].getZugaenglichkeit()==true){
            ...
            if(Spiel.neuerHeld.getHP()>0){
                ...
                System.out.println("Du hast es nicht geschafft zu fliehen. Beim Versuch hast du "+schaden+" Schaden erlitten und hast noch 0 Leben.");
            }
            System.out.println();

            if(Spiel.neuerHeld.getHP()<=0){
                System.out.println("Du wurdest beim Versuch zu fliehen von einem/einer "+Spiel.neueWelt.welt[xPos][yPos].gegner[0].getName()+" getötet und hast verloren!");
                Pause(2000);
                System.exit(0 );
            }
        }
    ...
    public static void angreifen()
    {
        ...
        if(Spiel.neuerHeld.Ruestung[0]!=null){
            if(Spiel.neueWelt.welt[xPos][yPos].gegner[0].getAS()-Spiel.neuerHeld.Parrierbonus()+Spiel.neueWelt.welt[xPos][yPos].gegner[0].Bonusschaden()-Spiel.neuerHeld.Ruestung[0].getSW()>0){
                aWGegner=Spiel.neueWelt.welt[xPos][yPos].gegner[0].getAS()-Spiel.neuerHeld.Parrierbonus()+Spiel.neueWelt.welt[xPos][yPos].gegner[0].Bonusschaden()-Spiel.neuerHeld.Ruestung[0].getSW();
            }else{
                aWGegner=0;
            }
        }else{
        ...
        if(Spiel.neueWelt.welt[xPos][yPos].gegner[0].getLeben()>0){
            ...
            System.out.println("Du greifst den/die/das "+Spiel.neueWelt.welt[xPos][yPos].gegner[0].getName()+" an und machst "+aWHeld+" Schaden. Der/Die/Das "+Spiel.neueWelt.welt[xPos][yPos].gegner[0].getName()+" hat jetzt noch 0 Leben.");
        }
        System.out.println();
        Pause(500);
        ...
        if(Spiel.neuerHeld.getHP()>0){
            ...
            System.out.println("Der/Die/Das "+Spiel.neueWelt.welt[xPos][yPos].gegner[0].getName()+" greift dich an und macht "+aWGegner+" Schaden. Du hast jetzt noch 0 Leben.");
        }
        System.out.println();
